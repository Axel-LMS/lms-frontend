<template>
   ...
   <h1 class="text-3xl text-sky-400 text-center mb-2">TeacherPerCourse Edit Page</h1>
        ...
        <div class="w-5/12">
          ...
          <div class="mb-3 w-5/12">
            ...
            <div class="mb-3 w-full mx-12">
              ...
              <button class="text-gray-900 hover:bg-gray-300 font-semibold bg-gray-50 rounded-sm w-11/12 py-2 mb-2">Edit</button>
...
export default {
  ...
  mounted(){
    ...
    ApiService.get("/admin/clubs/"+this.id)
    .then((response) => {
  ...
  methods : {
      EditFunction() {
          ApiService.patch("admin/clubs/"+this.id, this.InputData)
          .then((response) => { 
