<template>
     ...
     <h1 class="text-3xl text-sky-400 text-center mb-3">CourseByCycle Edit Page</h1>
...
export default {
    ...
    methods : {
        EditFunction() {
            ApiService.patch("admin/coursebycycles/"+this.id,this.InputData)
            .then((response) => {
                if(response.data.condition){
                    this.$router.push("/admin/coursebycycles");
                }else {
