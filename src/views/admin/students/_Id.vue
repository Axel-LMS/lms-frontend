<template>
     ...
     <h1 class="text-3xl text-sky-400 text-center mb-2">Student Edit Page</h1>
...
export default {
    ...
    mounted() {
        ApiService.get("admin/students/"+this.id)
        .then((response) => {
    ...
    methods : {
        EditFunction() {
            ApiService.patch("admin/students/"+this.id, this.InputData)
            .then((response) => {
