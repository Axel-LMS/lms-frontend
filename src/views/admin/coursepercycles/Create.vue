<template>
 ...
 <h1 class="text-3xl text-sky-400 text-center mb-3">CoursePerCycle Create Page</h1>
...
methods : {
    CreateFunction() {
        let self = this
        ApiService.post("admin/coursepercycles",this.InputData)
        .then((response) => {
            if(response.data.condition){
                self.$router.push("/admin/coursepercycles");
            }else {
